...
while True:
    ...
    cv2.line(frame, (section_width, 0), (section_width, frame_height), (255, 255, 0), 2)  # Line for "Left"
    cv2.line(frame, (2 * section_width, 0), (2 * section_width, frame_height), (255, 255, 0), 2)  # Line for "Slightly Left"
    cv2.line(frame, (3 * section_width, 0), (3 * section_width, frame_height), (255, 255, 0), 2)  # Line for "Slightly Right"
    ...
    detected_sections = {"Left": False, "Slightly Left": False, "Slightly Right": False, "Right": False}
